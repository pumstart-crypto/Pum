    ...
    <Layout hideTopBar>
      <div className="pb-32">
        ...
        <div className="mx-5 rounded-3xl bg-white border border-border/20 shadow-sm flex flex-col items-center justify-center py-20 gap-4">
          <span className="material-symbols-outlined text-6xl text-muted-foreground/20">directions_bus</span>
          <p className="text-sm font-semibold text-muted-foreground/50">실시간 버스 위치</p>
