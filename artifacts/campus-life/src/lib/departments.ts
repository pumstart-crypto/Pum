export interface CollegeDepts {
  college: string;
  depts: string[];
}

export const DEPT_BY_COLLEGE: CollegeDepts[] = [
  ...
  { college: "공과대학", depts: ["기계공학부","고분자공학과","유기소재시스템공학과","화공생명공학과","환경공학과","전자공학전공","전기공학전공","반도체공학전공","조선해양공학과","재료공학부","산업공학과","항공우주공학과","건축공학과","건축학과","도시공학과","사회기반시스템공학과","미래도시건축환경융합전공","첨단IT자율전공","첨단모빌리티자율전공","첨단소재자율전공","스마트시티전공"] },
...
export const ALL_DEPTS: string[] = DEPT_BY_COLLEGE.flatMap((c) => c.depts);

export const SUPPORTED_DEPTS = new Set<string>([
  "국어국문학과","중어중문학과","일어일문학과","영어영문학과","불어불문학과","독어독문학과","노어노문학과","한문학과","언어정보학과","사학과","철학과","고고학과",
  "행정학과","정치외교학과","사회복지학과","사회학과","심리학과","문헌정보학과","미디어커뮤니케이션학과",
  "수학과","통계학과","물리학과","화학과","생명과학과","분자생물학과","미생물학과","지질환경과학과","대기환경과학과","해양학과",
  "기계공학부","고분자공학과","유기소재시스템공학과","화공생명공학과","환경공학과","전자공학전공","전기공학전공","반도체공학전공","조선해양공학과","재료공학부","산업공학과","항공우주공학과","건축공학과","건축학과","도시공학과","사회기반시스템공학과","미래도시건축환경융합전공","첨단IT자율전공","첨단모빌리티자율전공","첨단소재자율전공",
]);
