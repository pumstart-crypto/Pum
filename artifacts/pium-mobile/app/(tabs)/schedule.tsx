...
const styles = StyleSheet.create({
  ...
  filterChip: { paddingHorizontal: 14, paddingVertical: 5, borderRadius: 20, backgroundColor: '#F3F4F6', marginRight: 8, flexDirection: 'row', alignItems: 'center', gap: 4 },
  ...
  filterSearchBox: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#F3F4F6', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 5, marginRight: 8 },
